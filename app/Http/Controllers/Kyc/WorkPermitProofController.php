...
use App\Http\Requests\Kyc\WorkPermitProofRequest;
...
class WorkPermitProofController extends Controller
{
    protected $uploadDoc;
    ...
    /**
     * @group Kyc
     * Upload Work permit proof documents
     ...
     * @authenticated
     *
     * @responseFile 422 responses/Kyc/WorkPermitProof/422.json
     *
     * @responseFile 200 responses/Kyc/WorkPermitProof/200.json
     *
     */
    public function storePermit(WorkPermitProofRequest $request) {
